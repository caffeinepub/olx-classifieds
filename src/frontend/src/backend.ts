...
export class Backend implements backendInterface {
    ...
    async createListing(arg0: ListingDTO): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getListings(arg0: string | null, arg1: string | null): Promise<Array<Listing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListings(to_candid_opt_n14(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n14(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateListing(arg0: bigint, arg1: ListingDTO): Promise<void> {
        if (this.processError) {
            try {
